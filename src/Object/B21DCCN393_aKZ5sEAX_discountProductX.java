 ...
 */
//[Mã câu hỏi (qCode): aKZ5sEAX].  Một chương trình (tạm gọi là RMI Server) cung cấp các mã khuyến mãi sản phẩm ngẫu nhiên cho sinh viên, được mô tả như sau:
//•	Giao diện từ xa
 ...
 * @author hoang
 */
public class B21DCCN393_aKZ5sEAX_discountProductX {
    public static void main(String[] args) throws Exception{
        String studentCode = "B21DCCN393";
        String qCode = "aKZ5sEAX";
       Registry rg = LocateRegistry.getRegistry("203.162.10.109");
        ...
        for(int i = 0 ; i < disCode.length(); i++){
            ...
            // chi tinh digit thoi nhe 
            if(Character.isDigit(c)) sum += (int) (c-'0');
