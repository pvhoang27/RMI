...
// */
//[Mã câu hỏi (qCode): scSjz9rh].  Một chương trình (tạm gọi là RMI Server) cung cấp giao diện cho phép triệu gọi từ xa để xử lý dữ liệu nhị phân.
//Giao diện từ xa:
 ...
 * @author hoang
 */
public class B21DCCN017_scSjz9rh_ChuyenSangHex {
    public static void main(String[] args ) throws Exception{
        String studentCode = "B21DCCN017", qCode = "scSjz9rh";
        ...
        for(int i = 0  ; i < a.length; i++){
            kq += Integer.toHexString(a[i]);
        }
        System.out.println(kq);
        byte[] kqb = kq.getBytes();
        System.out.println(kqb);
        System.out.println(Arrays.toString(kqb));
        
        sv.submitData(studentCode, qCode, kqb);
     }
}
