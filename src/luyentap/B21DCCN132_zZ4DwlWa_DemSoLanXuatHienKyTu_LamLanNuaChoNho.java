 ...
 */
//[Mã câu hỏi (qCode): zZ4DwlWa].  Một chương trình (tạm gọi là RMI Server) cung cấp giao diện cho phép triệu gọi từ xa để xử lý chuỗi.
//Giao diện từ xa:
 ...
 * @author hoang
 */
public class B21DCCN132_zZ4DwlWa_DemSoLanXuatHienKyTu_LamLanNuaChoNho {
    public static void main(String[] args) throws Exception{
        String studentCode = "B21DCCN132";
        String qCode = "zZ4DwlWa";
