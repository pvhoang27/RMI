//[Mã câu hỏi (qCode): PmVC5Rrk].  Một chương trình (tạm gọi là RMI Server) cung cấp giao diện cho phép triệu gọi từ xa để xử lý dữ liệu nhị phân.
//Giao diện từ xa:
...
public class MaHoaCaesar {
    public static void main(String[] args) throws Exception{
        String studentCode = "B22DCCN104",qCode = "PmVC5Rrk";
