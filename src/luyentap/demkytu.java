//[Mã câu hỏi (qCode): rZ2sRPay].  Một chương trình (tạm gọi là RMI Server) cung cấp giao diện cho phép triệu gọi từ xa để xử lý chuỗi.
//Giao diện từ xa:
...
public class demkytu {
    public static void main(String[] args) throws Exception{
        String studentCode = "B22DCCN008",qCode = "rZ2sRPay";
